<?php
    ...
    $cont = $start_from;
    $sql = "SELECT socio.id, socio.num_tarjeta, socio.nombre, socio.apellido, socio.telefono, casa.pasaje, casa.poligono, casa.num_casa FROM socio INNER JOIN casa ON socio.id_casa = casa.id_casa WHERE socio.activo='0' LIMIT $start_from, $record_per_page";
	...
	while($data = mysqli_fetch_array($result)){
        ...
        $output .= '
            <tr>
                ...
                <td><a href="activarUsuario.php?sshs='.$data["id"].'&ante=verNoAct.php" ><span class="icon">&#xe105;</span></a></td>
    ...
    $output .= '</tbody>
              ...
              ';
    $recordSql = "SELECT * FROM socio WHERE activo='0'";
